...
if(isset($_POST['rezervoDekorimin'])) {	
	...
	if( empty($Emri) || empty($Mbiemri)|| empty($Email) || empty($Data_takimit)) {			
		...
		$rezultati = mysqli_query($lidhu, "INSERT INTO umdas_rezervimet_dekorimeve (ID_Ambienti,Emri,Mbiemri,Email,Data_takimit) VALUES('$ID_Ambienti','$Emri','$Mbiemri','$Email','$Data_takimit')");
