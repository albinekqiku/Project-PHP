															...
															<tr bgcolor='#CCCCCC'>
																...
																<td>Fshijë</td>
																	...
																	while($rresht = mysqli_fetch_array($sql)) { 		
																			...
																			echo "<td><a href=\"fshijeRezervim.php?ID_Rezervimi=$rresht[ID_Rezervimi]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini rezervimin?')\" class='button' 
