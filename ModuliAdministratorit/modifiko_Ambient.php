								...
								<div class="inner">
									...
									<!-- Elements -->
												...
												<form style="width:73%" method="post" action="">
														<table>
																<tr>
																<h3>Kërko të dhënat e ambientit për modifikim</h3>
																</tr>
															...
															<tr bgcolor='#CCCCCC'>
																...
																<td>Modifiko</td>
																	...
																	while($rresht = mysqli_fetch_array($sql)) { 		
																			...
																			echo "<td><a href=\"modifikoAmbient.php?ID_Ambienti=$rresht[ID_Ambienti]\" class='button' class='button primary'>
																			Modifiko</a></td></tr>";		
																		}
