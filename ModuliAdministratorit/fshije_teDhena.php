								...
								<div class="inner">
									...
									<!-- Elements -->
												...
												<form style="width:73%" method="post" action="">
														<table>
																<tr>
																<h3>Kërko të dhënë për fshirje</h3>
																</tr>
															...
															<tr bgcolor='#CCCCCC'>
																...
																<td>Fshijë</td>
																	...
																	while($rresht = mysqli_fetch_array($sql)) { 		
																			...
																			echo "<td><a href=\"fshijeteDhena.php?ID_tedhenat=$rresht[ID_tedhenat]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini te dhenen?')\" 
