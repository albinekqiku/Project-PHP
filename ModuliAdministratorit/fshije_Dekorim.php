								...
								<div class="inner">
									...
									<!-- Elements -->
												...
												<form style="width:73%" method="post" action="">
														<table>
																<tr>
																<h3>Kërko të dhënat e dekorimit për fshirje</h3>
																</tr>
															...
															<tr bgcolor='#CCCCCC'>
																...
																<td>Fshije</td>
																	...
																	while($rresht = mysqli_fetch_array($sql)) { 		
																			...
																			echo "<td><a href=\"fshijeDekorim.php?ID_Dekorimi=$rresht[ID_Dekorimi]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini dekorimin?')\" class='button' 
