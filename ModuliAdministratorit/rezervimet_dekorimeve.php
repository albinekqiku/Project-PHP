									...
									<!-- Elements -->
												...
												<section id="one" class="tiles">
													...
													<article>
														...
														<header class="major">
															<h3><a href="shto_Rezervim.php" class="link">Shto rezervim per dekorim</a></h3>
													...
													<article>
														...
														<header class="major">
															<h3><a href="modifiko_Rezervim.php" class="link">Modifiko rezervim per dekorim</a></h3>
													...
													<article>
														...
														<header class="major">
															<h3><a href="fshije_Rezervim.php" class="link">Fshije rezervim per dekorim</a></h3>
